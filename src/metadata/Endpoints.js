export const apiEndpoint = 'https://zrdqlzn6f5.execute-api.ap-southeast-2.amazonaws.com/prod/v0/rest';
...
export const userSavedImagesCDN = 'https://d3rn1cnf3wdnbk.cloudfront.net'
