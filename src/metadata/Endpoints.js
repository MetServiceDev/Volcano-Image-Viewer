export const apiEndpoint = 'https://g43sxzej92.execute-api.ap-southeast-2.amazonaws.com/prod/v0/rest';
export const imageBucket = 'https://d2e7bw4oknorz6.cloudfront.net';
...
export const userSavedImagesCDN = 'https://d2ig5i70fribjk.cloudfront.net';
